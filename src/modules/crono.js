...
if (
  ...
  actividades_json.forEach((actividad) => {
    let svgButtonRemove = `<button id="${formato_string(actividad.nombre,"reverse")} class='boton-quitar'><svg viewBox="0 0 15 17.5" height="17.5" width="15" xmlns="http://www.w3.org/2000/svg" class="icon">
