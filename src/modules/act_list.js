...
let svgButton = `<button id="${funciones.formato_string(actividad.nombre,"reverse")}" class='boton_lapiz'>
...
let svgButtonAdd = `<button id ="${funciones.formato_string(actividad.nombre,"reverse")}" class='boton_agregar' ><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 24 24' fill='none' stroke='white' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M12 5v14m-7-7h14'/></svg></button>`;

let svgButtonDesc = `<button id="${funciones.formato_string(actividad.nombre,"reverse")}" class='boton_descripcion'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 24 24' fill='none' stroke='white' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M3 12h18M3 6h18M3 18h18'/></svg></button>`;
        let linea =
          "<tr> <td>" +
          actividad.duracion +
          " min </td><td>" +
